...
hi DiagnosticError guifg=red ctermfg=red guibg=NONE ctermbg=NONE gui=underline cterm=underline 
hi DiagnosticWarn guifg=yellow ctermfg=yellow guibg=NONE ctermbg=NONE gui=underline cterm=underline 
hi link LspErrorHighlight DiagnosticError
hi link LspWarningHighlight DiagnosticWarn
hi LspInformationHighlight guifg=blue ctermfg=yellow guibg=NONE ctermbg=NONE gui=underline cterm=underline 
hi link LspInformationHighlight LspHintHighlight
hi link LspInformationHighlight  DiagnosticError 
